...
const MATERIAL_MODULES = [MatIconModule, MatButtonModule, MatTooltipModule, MatDividerModule, MatListModule];

@Component({
  selector: 'lars-sidepanel',
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, ...MATERIAL_MODULES],
