...
const CDK_MODULES = [ScrollingModule];

const MATERIAL_MODULES = [MatIconModule, MatProgressSpinner];

@Component({
  selector: 'lars-logs-list',
  standalone: true,
  imports: [CommonModule, LogsDomainModule, AgGridAngular, ...CDK_MODULES, ...MATERIAL_MODULES],
